...
#define MAVLINK_THIS_XML_HASH 1055106131143512029
...
/** @brief  */
#ifndef HAVE_ENUM_MAV_VEHICLE_CONDITION
#define HAVE_ENUM_MAV_VEHICLE_CONDITION
typedef enum MAV_VEHICLE_CONDITION
{
   MAV_VEHICLE_CONDITION_GLOBAL_POSITION=1, /* 0x01 global position | */
   MAV_VEHICLE_CONDITION_LOCAL_POSITION=2, /* 0x02 local position | */
   MAV_VEHICLE_CONDITION_LOCAL_VELOCITY=4, /* 0x04 local velocity | */
   MAV_VEHICLE_CONDITION_LOCAL_ALTITUDE=8, /* 0x08 local altitude | */
   MAV_VEHICLE_CONDITION_DATALINK_LOSS=16, /* 0x16 datalink loss | */
   MAV_VEHICLE_CONDITION_HOME_POSITION=32, /* 0x32 indicates a valid home position (a valid home position is not always a valid launch | */
   MAV_VEHICLE_CONDITION_AUTO_MISSION_AVAILABLE=64, /* 0x64 auto mission available | */
   MAV_VEHICLE_CONDITION_ENUM_END=65, /*  | */
} MAV_VEHICLE_CONDITION;
#endif
