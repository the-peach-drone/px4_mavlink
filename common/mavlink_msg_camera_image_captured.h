...
typedef struct __mavlink_camera_image_captured_t {
 ...
 float roll; /*< [rad] Altitude above ground in meters, expressed as * 1E3 where image was taken*/
 float pitch; /*< [rad] Altitude above ground in meters, expressed as * 1E3 where image was taken*/
 float yaw; /*< [rad] Altitude above ground in meters, expressed as * 1E3 where image was taken*/
...
#define MAVLINK_MSG_ID_CAMERA_IMAGE_CAPTURED_LEN 46
#define MAVLINK_MSG_ID_CAMERA_IMAGE_CAPTURED_MIN_LEN 46
#define MAVLINK_MSG_ID_263_LEN 46
#define MAVLINK_MSG_ID_263_MIN_LEN 46

#define MAVLINK_MSG_ID_CAMERA_IMAGE_CAPTURED_CRC 53
#define MAVLINK_MSG_ID_263_CRC 53
...
#define MAVLINK_MESSAGE_INFO_CAMERA_IMAGE_CAPTURED { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 8, offsetof(mavlink_camera_image_captured_t, time_boot_ms) }, \
         ...
         { "roll", NULL, MAVLINK_TYPE_FLOAT, 0, 28, offsetof(mavlink_camera_image_captured_t, roll) }, \
         { "pitch", NULL, MAVLINK_TYPE_FLOAT, 0, 32, offsetof(mavlink_camera_image_captured_t, pitch) }, \
         { "yaw", NULL, MAVLINK_TYPE_FLOAT, 0, 36, offsetof(mavlink_camera_image_captured_t, yaw) }, \
         { "image_index", NULL, MAVLINK_TYPE_INT32_T, 0, 40, offsetof(mavlink_camera_image_captured_t, image_index) }, \
         { "capture_result", NULL, MAVLINK_TYPE_INT8_T, 0, 45, offsetof(mavlink_camera_image_captured_t, capture_result) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_CAMERA_IMAGE_CAPTURED { \
 ...
 * @param roll [rad] Altitude above ground in meters, expressed as * 1E3 where image was taken
 * @param pitch [rad] Altitude above ground in meters, expressed as * 1E3 where image was taken
 * @param yaw [rad] Altitude above ground in meters, expressed as * 1E3 where image was taken
...
static inline uint16_t mavlink_msg_camera_image_captured_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint32_t time_boot_ms, uint64_t time_utc, uint8_t camera_id, int32_t lat, int32_t lon, int32_t alt, int32_t relative_alt, float roll, float pitch, float yaw, int32_t image_index, int8_t capture_result)
{
    ...
    _mav_put_int32_t(buf, 40, image_index);
    _mav_put_uint8_t(buf, 44, camera_id);
    _mav_put_int8_t(buf, 45, capture_result);
...
static inline void mavlink_msg_camera_image_captured_send(mavlink_channel_t chan, uint32_t time_boot_ms, uint64_t time_utc, uint8_t camera_id, int32_t lat, int32_t lon, int32_t alt, int32_t relative_alt, float roll, float pitch, float yaw, int32_t image_index, int8_t capture_result)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_CAMERA_IMAGE_CAPTURED_LEN];
    _mav_put_uint64_t(buf, 0, time_utc);
 ...
 */
static inline void mavlink_msg_camera_image_captured_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, uint64_t time_utc, uint8_t camera_id, int32_t lat, int32_t lon, int32_t alt, int32_t relative_alt, float roll, float pitch, float yaw, int32_t image_index, int8_t capture_result)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field roll from camera_image_captured message
 *
 * @return [rad] Altitude above ground in meters, expressed as * 1E3 where image was taken
 */
static inline float mavlink_msg_camera_image_captured_get_roll(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float(msg,  28);
}

/**
 * @brief Get field pitch from camera_image_captured message
 *
 * @return [rad] Altitude above ground in meters, expressed as * 1E3 where image was taken
 */
static inline float mavlink_msg_camera_image_captured_get_pitch(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float(msg,  32);
}

/**
 * @brief Get field yaw from camera_image_captured message
 *
 * @return [rad] Altitude above ground in meters, expressed as * 1E3 where image was taken
 */
static inline float mavlink_msg_camera_image_captured_get_yaw(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_camera_image_captured_decode(const mavlink_message_t* msg, mavlink_camera_image_captured_t* camera_image_captured)
{
    ...
    camera_image_captured->roll = mavlink_msg_camera_image_captured_get_roll(msg);
    camera_image_captured->pitch = mavlink_msg_camera_image_captured_get_pitch(msg);
    camera_image_captured->yaw = mavlink_msg_camera_image_captured_get_yaw(msg);
